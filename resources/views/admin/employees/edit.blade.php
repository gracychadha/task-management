    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="flex items-center gap-4">
                <div class="flex-shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white text-lg font-bold shadow-md shadow-indigo-500/20">{{ $employee->initials() }}</div>
                <div>
                    ...
                    <form method="POST" action="{{ route('admin.employees.update', $employee) }}">
                        ...
                        <div class="mb-8">
                            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4 flex items-center gap-2">
                                <span class="w-6 h-6 rounded-lg bg-indigo-100 flex items-center justify-center">
                                    <svg class="w-3.5 h-3.5 text-indigo-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                                </span>
                                Profile Information
                            </h3>
                            <div class="space-y-4 pl-9">
                                <div>
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full rounded-xl" :value="old('name', $employee->name)" required />
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        ...
                                        <x-text-input id="email" name="email" type="email" class="pl-9 block w-full rounded-xl" :value="old('email', $employee->email)" required />
                                    </div>
                            ...
                            <div class="space-y-4 pl-9">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="position" name="position" type="text" class="mt-1 block w-full rounded-xl" :value="old('position', $employee->position)" />
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative">
                                            ...
                                            <x-text-input id="phone" name="phone" type="text" class="pl-9 block w-full rounded-xl" :value="old('phone', $employee->phone)" />
                                        </div>
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4 flex items-center gap-2">
                                <span class="w-6 h-6 rounded-lg bg-violet-100 flex items-center justify-center">
                                    <svg class="w-3.5 h-3.5 text-violet-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
                                </span>
                            ...
                            <div class="space-y-4 pl-9">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="password_confirmation" name="password_confirmation" type="password" class="mt-1 block w-full rounded-xl" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                            ...
                            <button type="submit" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 text-sm font-medium text-white shadow-md shadow-indigo-500/25 hover:shadow-lg hover:-translate-y-0.5 transition">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 14.66V20a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2h5.34"/><polygon points="18 2 22 6 12 16 8 16 8 12 18 2"/></svg>
                                Update Employee
                            </button>
                        </div>
                    </form>

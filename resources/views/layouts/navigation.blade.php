            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif($role === 'manager')
                        ...
                        <x-nav-link :href="route('manager.performance')" :active="request()->routeIs('manager.performance')">
                            {{ __('Performance') }}
                        </x-nav-link>
                    @else
                        ...
                        <x-nav-link :href="route('employee.notifications')" :active="request()->routeIs('employee.notifications')">
                            {{ __('Notifications') }}
                            @if(\App\Models\UserNotification::where('user_id', Auth::id())->unread()->count() > 0)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif($role === 'manager')
                ...
                <x-responsive-nav-link :href="route('manager.performance')" :active="request()->routeIs('manager.performance')">
                    {{ __('Performance') }}
                </x-responsive-nav-link>
            @else
